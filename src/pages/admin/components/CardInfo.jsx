...
function CardInfo({imgUrl,_id,type,children}) {
  ...
  return (
    <motion.div className='overflow-hidden border-1 bg-white rounded-lg shadow-lg  max-h-auto flex justify-center  items-center flex-col cursor-pointer relative' key={`${type}_${_id}`}>
        <motion.img 
