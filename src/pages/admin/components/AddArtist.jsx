...
function AddArtist() {
    ...
    const saveArtist = async () => {
        ...
        // save artist code  
        console.log(ArtitsFields);
        axios.post(artistApi,ArtitsFields).then(({data})=>{
            if(data.status === 201){
                SetMsg("Artist has been added");
        ...
        <div className='flex gap-4 items-center'>
            ...
            <div>
                <div className='flex flex-col gap-4'>
                    ...
                    />
                    <input type='text' className='p-4 rounded-lg' value={ArtitsFields.instagram} name='instagram' placeholder='instagram url' 
                        onChange={handleOnChange} 
                    />
                    <input type='text' className='p-4 rounded-lg' value={ArtitsFields.twitter} name='twitter' placeholder='twitter url' 
                        onChange={handleOnChange} 
                    />
                    <input type='text' className='p-4 rounded-lg' value={ArtitsFields.facebook} name='facebook' placeholder='facebook url' 
                        onChange={handleOnChange} 
                    />
                </div>
